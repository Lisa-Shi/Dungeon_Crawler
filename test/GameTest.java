...
public class GameTest extends ApplicationTest {
    ...
    public void testPushLeft() {
        ...
        assertEquals(-Main.DEFAULT_CONTROL_PLAYER_FORCE, player.getPhysics().getVelocity().getX(),0.001);
    ...
    public void testPushUp() {
        ...
        assertEquals(-Main.DEFAULT_CONTROL_PLAYER_FORCE, player.getPhysics().getVelocity().getY() ,0.001);
        assertEquals(0, player.getPhysics().getAcceleration().getX(),0.001);
        assertEquals(0, player.getPhysics().getAcceleration().getY(),0.001);
    }
    @Test
