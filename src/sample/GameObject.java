...
public abstract class GameObject implements Physical, Drawable {
    ...
    // Constructors
    public GameObject(Room room, double initialX, double initialY, double centerX, double centerY, String spriteName) {
        this.physics = new PhysicsControllerRelative(initialX, initialY, room.getPhysics());
        this.sprite = new Sprite((int) initialX, (int) initialY, (int) (centerX * 2), (int) (centerY * 2),
